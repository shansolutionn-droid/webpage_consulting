...
function ServicesPage() {
  return (
    <main>
      <PageHero kicker="Services" title="Engineering support shaped around the brief.">
        AXIA brings electrical and mechanical consulting together to help project teams understand
        systems, weigh options, and make sound technical decisions.
      </PageHero>
      ...
      <section className="bg-bg">
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 px-5 py-16 sm:px-8 md:flex-row md:items-center">
          <p className="max-w-md font-display text-2xl text-fg">
            Not sure where to begin? Tell us what you are working through.
          </p>
          <Link
            to="/contact"
